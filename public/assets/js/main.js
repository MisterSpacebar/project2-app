$(function () {
    ...
    $(document).on("click", "#add", function () {
        ...
        var chosenEntry = dataResponse[toEdit];
        console.log(chosenEntry);

        var chosenQuantity = $(this).closest('tr').find('input').val();
        ...
        var newProduct = {
            name: chosenEntry.name,
            category: chosenEntry.category,
            price: chosenEntry.price,
            manufacturer: chosenEntry.manufacturer || chosenEntry.brand,
